...
import name.martingeisse.trading_game.application.configuration.annotated.AnnotatedConfigurationParticipant;
import name.martingeisse.trading_game.application.configuration.annotated.ConfigurationSetting;
