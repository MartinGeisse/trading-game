...
public final class OpenLayers {
	...
	public static final JavaScriptResourceReference JAVASCRIPT_DEBUG_RESOURCE_REFERENCE = new JavaScriptResourceReference(OpenLayers.class, "ol-debug.js");
	...
	public static void renderHead(IHeaderResponse response) {
		response.render(JavaScriptHeaderItem.forReference(JAVASCRIPT_DEBUG_RESOURCE_REFERENCE));
