package name.martingeisse.trading_game.game.action.take2.actions;

import name.martingeisse.trading_game.game.action.ProgressSnapshot;
import name.martingeisse.trading_game.game.action.take2.Action;
import name.martingeisse.trading_game.game.action.take2.CannotStartActionException;
